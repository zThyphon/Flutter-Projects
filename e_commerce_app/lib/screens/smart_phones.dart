...
class SmartphonesPage extends StatefulWidget {
  ...
  @override
  State<SmartphonesPage> createState() => _SmartphonesPageState();
}

class _SmartphonesPageState extends State<SmartphonesPage> {
  @override
        ...
        children: [
          const Center(
            child: Column(
              children: [
                SizedBox(height: 40),
                Text("Smart Phones", style: AppStyle.dateStyle),
                SizedBox(height: 20),
              ],
            ),
          ),
