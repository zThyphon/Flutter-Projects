...
class AppStyle {
  ...
  static const TextStyle profileHeaderStyle = TextStyle(
      fontFamily: "Open Sans",
      fontWeight: FontWeight.w500,
      fontSize: 24.0,
      color: Colors.black);
  static const TextStyle profileButtonStyle = TextStyle(
      fontFamily: "Open Sans",
      fontWeight: FontWeight.w500,
      fontSize: 20.0,
      color: Colors.white);
  static const TextStyle profileMailStyle = TextStyle(
      fontFamily: "Open Sans",
      fontWeight: FontWeight.w400,
      fontSize: 22.0,
      color: Colors.black);

  static const TextStyle addBasketButtonStyle = TextStyle(
      fontFamily: "Open Sans",
      fontWeight: FontWeight.w500,
      fontSize: 18.0,
      color: Colors.white);
